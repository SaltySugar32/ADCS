...
//TODO: условие непрерывности функций
//TODO: ввести независимость от скорости - деформация = производная изменения перемещения от координаты
//Предположение: для новосоздаваемого волнового фронта деформация - значение параметра A2,
// для существующего - производная на двух концах
//TODO: перепроверить все граничные взаимодействия
