...
//TODO: создание нового волнового фронта в случае противоположных по типу деформации волновых фронтов - нужна скорость
//TODO: обработка столкновений волновых фронтов
//TODO: проверка столкновения с границей полупространства
//TODO: V создание множества волновых фронтов в случае их попадания в квази-одну координату x
