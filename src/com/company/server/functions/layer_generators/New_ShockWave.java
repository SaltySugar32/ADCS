package com.company.server.functions.layer_generators;
...
//Здесь должно быть решение СНЛАУ
public class New_ShockWave {
    /**
     *TODO: 16 уравнений в частных производных для четырёх уравнений, характеризующих слой деформации
     * это: три уравнения плюс уравнение скорости ударной волны в квадрате
     */
    ...
    public static LayerDescription generatePositiveShockWave(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, double currentTime, double speed, WaveType waveType) {
        //!!!!КОСТЫЛЬ!!!!
        double speedR = (speed + SimGlobals.getCharacteristicsSpeedStretching()) / 2;
