package com.company.server.simulation.types;
...
public class LayerDescription {
    ...
    public double calculateLayerDisplacement() {
        return (getA0() + getA1() * (SimTime.getSimulationTime() - layerStartTime) + getA2() * currentX);
    }
    ...
    public double calculateZeroDisplacement() {
        return (getA0() + getA1() * (SimTime.getSimulationTime() - layerStartTime));
    }
    ...
    public double calculateDeformations() {
        double left = getA0() +
                getA1() * (SimTime.getSimulationTime() - layerStartTime) +
                getA2() * currentX;
        double right = getA0() +
                getA1() * (SimTime.getSimulationTime() - layerStartTime) +
                getA2() * (currentX + 10);
