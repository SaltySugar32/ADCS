...
public class SimpleFracture {
    public static LayerDescription generateFastPositive(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, WaveType waveType) {
        double speedR = SimulationGlobals.getCharacteristicsSpeedCompression();

        return generateNewLayer(prevLayerDescriptions, currentX, speedR, waveType);

    }

    public static LayerDescription generateFastNegative(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, WaveType waveType) {
    ...
    public static LayerDescription generateSlowPositive(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, WaveType waveType) {
    ...
    public static LayerDescription generateSlowNegative(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, WaveType waveType) {
    ...
    public static LayerDescription generateNewLayer(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, double speedR, WaveType waveType) {
