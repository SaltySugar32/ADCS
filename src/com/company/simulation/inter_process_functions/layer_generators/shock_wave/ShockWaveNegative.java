...
public class ShockWaveNegative {
    public static LayerDescription generatePositiveShockWave(ArrayList<LayerDescription> prevLayerDescriptions, double currentX, WaveType waveType) {
        //!!!!КОСТЫЛЬ!!!!
